(function(global){"use strict";
 ...
 async function loadTerminPackageUpdate(){try{await loadScript("js/vendor/jszip.min.js?v=3.10.1");await loadScript("js/features/reports/zip-terminpakete.js?v=20260920-2182");}catch(error){console.error(error);}}
